...
/*
 * The URL and other things are declared as constants because their
 * values will not change at any time.
 */
public class Constants {

	public static final String ACTIVEMQ_CONNECTION_URL = "activemq.connectionUrl";
