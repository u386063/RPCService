...
public class BSTNegative {
	...
	public void testSearch() {
		assertEquals("Search Node Test",searchResult,bst.searchNode("81"));
	}
	...
	public void testFindMax(){
		assertEquals("Maximum element in the binary search tree","1",bst.findMax());
	}
	
	@Test
	public void testFindMin(){
		assertEquals("Minimum element in the binary search tree","14",bst.findMin());
	}
